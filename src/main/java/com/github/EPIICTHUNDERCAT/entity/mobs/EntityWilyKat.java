...
public class EntityWilyKat extends EntityCreature {

	public static final ResourceLocation LOOT = new ResourceLocation(Reference.ID, "entities/wilykat");

	public EntityWilyKat(World worldIn) {
		super(worldIn);
