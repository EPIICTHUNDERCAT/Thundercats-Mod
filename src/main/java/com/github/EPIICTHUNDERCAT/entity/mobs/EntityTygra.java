...
public class EntityTygra extends EntityCreature {
//Will Add this when boss and enemies are in
	//this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, true));
	private int attackTimer;
	private int holdWhipTick;
	// Still need to implement
	public static final ResourceLocation LOOT = new ResourceLocation(Reference.ID, "entities/tygra");

	public EntityTygra(World worldIn) {
		super(worldIn);
	...
	public int getHoldWhip() {
		return this.holdWhipTick;
	}
