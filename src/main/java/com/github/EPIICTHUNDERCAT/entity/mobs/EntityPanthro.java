...
public class EntityPanthro extends EntityCreature {
	//Will Add this when boss and enemies are in
		//this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntityPlayer.class, true));
		private int attackTimer;
		private int holdNunchucksTick;
		// Still need to implement
		public static final ResourceLocation LOOT = new ResourceLocation(Reference.ID, "entities/panthro");

		public EntityPanthro(World worldIn) {
			super(worldIn);
		...
		public void onLivingUpdate() {
			...
			if (this.holdNunchucksTick > 0) {
				--this.holdNunchucksTick;
			}
		...
		public int getHoldNunchucks() {
			return this.holdNunchucksTick;
		}
