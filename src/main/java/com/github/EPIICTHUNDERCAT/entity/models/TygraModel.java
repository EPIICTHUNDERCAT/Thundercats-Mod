...
public class TygraModel extends ModelBase {
    ...
    {
        EntityTygra entitytygra = (EntityTygra)entitylivingbaseIn;
        int i = entitytygra.getAttackTimer();
