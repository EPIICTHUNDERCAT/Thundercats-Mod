...
public class PanthroModel extends ModelBase {
    ...
    {
        EntityPanthro entitypanthro = (EntityPanthro)entitylivingbaseIn;
        int i = entitypanthro.getAttackTimer();
        ...
        {
            int j = entitypanthro.getHoldNunchucks();
