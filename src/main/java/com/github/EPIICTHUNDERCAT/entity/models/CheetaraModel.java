...
public class CheetaraModel extends ModelBase {
    ...
    {
        EntityCheetara entitycheetara = (EntityCheetara)entitylivingbaseIn;
        int i = entitycheetara.getAttackTimer();
        ...
        {
            int j = entitycheetara.getHoldStaff();
